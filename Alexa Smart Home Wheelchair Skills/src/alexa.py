...
particleToken = "insert token here";
particleDeviceId = "insert device id here";
...
def handleControl(context, event):
    ...
    #Color
        ...
        sendToParticle(deviceId, "color:" + str(hue) + ":" + str(saturation) + ":" + str(brightness));
        payload = {
            "achievedState": 
                {
                "color": 
